...
import com.spring.security.jwtsecurity.matcher.JwtAuthRequestMatcher;
...
public class JWTAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    private final RequestMatcher DEFAULT_REQUEST_MATCHER = new JwtAuthRequestMatcher();
    private static final String KEY_ALPHA = CONSTANT.KEY_ALPHA;
    private static final String KEY_BETA = CONSTANT.KEY_BETA;
    ...
    public void commence(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, AuthenticationException e) throws IOException, ServletException {
        ...
        LOGGER.info("Start matching URI with " + ((JwtAuthRequestMatcher)DEFAULT_REQUEST_MATCHER).getAutheticate_url());
